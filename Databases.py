...
class Database:
    ...
    def execute(self):
        ...
        mycursor.execute("CREATE TABLE if not exists  institution (IDINSTITUTION INT PRIMARY KEY AUTO_INCREMENT  ,EMAIL VARCHAR(255) NOT NULL , NAME VARCHAR(255) NOT NULL, PASSWORD VARCHAR(64) NOT NULL, CONSTRAINT UC_institution UNIQUE (EMAIL,NAME))")
