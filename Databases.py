...
class Database:
    ...
    def execute(self):
        ...
        mycursor.execute("CREATE TABLE if not exists  survey (IDSURVEY INT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(255) NOT NULL, JSON_DATA JSON)")
        ...
        mycursor.execute("CREATE TABLE if not exists surveystudents (IDSURVEY INT NOT NULL, IDSTUDENT INT NOT NULL, JSON_DATA JSON)")
